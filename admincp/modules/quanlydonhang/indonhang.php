...
// $sql_lietke_dh = "SELECT * FROM tbl_cart_details,tbl_sanpham,tbl_dangky WHERE tbl_cart_details.id_sanpham = tbl_sanpham.id_sanpham, tbl_dangky.id_dangky = tbl_cart.id_cart AND tbl_cart_details.code_cart = '" . $code . "' ORDER BY tbl_cart_details.id_cart_details DESC";
$query_lietke_dh = mysqli_query($mysqli, $sql_lietke_dh);

$pdf->Write(10, 'Đơn hàng của bạn gồm có:');
$pdf->Ln(10);

$width_cell = array(10, 35, 80, 20, 30, 40);
